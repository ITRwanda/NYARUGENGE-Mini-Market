...
return [
    ...
    'api_path' => [
        'include' => [
            'api/*', // 👈 Forces Scramble to scan all endpoints under api/v1
        ],
        'exclude' => [
            // Add any routes to skip here
        ],
    ],
    ...
    'info' => [
         ...
         */
        'description' => 'API documentation for the Nyarugenge Market Hygiene Monitoring project.',
    ],

    'ui' => [
        'title' => 'Nyarugenge Market API Docs',
    ],
    ...
    'renderers' => [
        /*
         * Stoplight Elements config options: https://stoplight.io
         */
        'elements' => [
            'view' => 'scramble::docs',
            'theme' => 'light',
        ...
        /*
         * Scalar API reference config options: https://scalar.com
         */
        'scalar' => [
            'view' => 'scramble::scalar',
            'cdn' => 'https://jsdelivr.net',
            'theme' => 'laravel',
            'proxyUrl' => 'https://scalar.com',
            'darkMode' => false,
     ...
     * middleware.
     */
    'security_strategy' => \Dedoc\Scramble\SecurityDocumentation\MiddlewareAuthSecurityStrategy::class, // 👈 ENABLED: This auto-adds Bearer auth layout keys
];
